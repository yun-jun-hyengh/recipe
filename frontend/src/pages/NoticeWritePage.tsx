            ...
            <div className="p-6 mx-auto max-w-screen-2xl">
                ...
                <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 lg:p-8">
                    ...
                    <div className="grid grid-cols-1 gap-4 py-2 md:grid-cols-4">
                        <label htmlFor="attach-file" className="pt-2 font-semibold text-gray-700 md:col-span-1">첨부파일</label>
                        <div className="flex flex-col items-start gap-2 md:col-span-3 sm:flex-row sm:items-center">
                            <div className="flex gap-2">
                                <button className="px-4 py-2 text-sm text-gray-800 bg-gray-200 rounded-md hover:bg-gray-300">파일 선택</button>
                                <button className="px-4 py-2 text-sm text-gray-800 bg-gray-200 rounded-md hover:bg-gray-300">선택된 파일 삭제</button>
                                <button className="px-4 py-2 text-sm text-white bg-blue-600 rounded-md hover:bg-blue-700">등록</button>
                            </div>
